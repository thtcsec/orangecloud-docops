/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f195a5689818d4e8632c966e53238924)
// Runtime types generated with workerd@1.20260730.1 2026-08-04 nodejs_compat
interface __BaseEnv_Env {
	DOCUMENTS_BUCKET: R2Bucket;
	DOCOPS_DB: D1Database;
	...
	APP_BASE_URL: "https://docops-stg.orangecloud.vn" | "https://docops.orangecloud.vn" | "http://localhost:5173";
	LOCAL_DEV_AUTH_ENABLED: "false" | "true";
	MAX_UPLOAD_BYTES: "26214400" | "52428800" | "10485760";
	PROCESSING_VERSION: "v1";
	UPLOAD_RATE_LIMIT: "30" | "20";
	API_RATE_LIMIT: "120" | "90";
	LOCAL_DEV_AUTH_EMAIL: string;
	LOCAL_DEV_AUTH_ROLE: string;
	LOCAL_DEV_AUTH_DISPLAY_NAME: string;
	DOCUMENT_WORKFLOW: Workflow<Parameters<import("./src/worker/index").DocumentProcessingWorkflow['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "APP_BASE_URL" | "LOCAL_DEV_AUTH_ENABLED" | "MAX_UPLOAD_BYTES" | "PROCESSING_VERSION" | "UPLOAD_RATE_LIMIT" | "API_RATE_LIMIT" | "LOCAL_DEV_AUTH_EMAIL" | "LOCAL_DEV_AUTH_ROLE" | "LOCAL_DEV_AUTH_DISPLAY_NAME" | "BOOTSTRAP_ADMIN_EMAILS">> {}
}
