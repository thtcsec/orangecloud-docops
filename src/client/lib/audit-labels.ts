...
const ACTION_EN: Record<string, string> = {
  ...
  "processing.extraction.completed": "Extraction completed",
  "processing.extraction.unavailable": "Extraction unavailable",
...
const ACTION_VI: Record<string, string> = {
  ...
  "processing.extraction.completed": "Hoàn tất trích xuất",
  "processing.extraction.unavailable": "Không trích xuất được",
